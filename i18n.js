...
const I18N = (() => {
  ...
  const translations = {
    en: {
      ...
      consent_part1: '<strong>Haptic Design (~8 min):</strong> Read 10 ghost-touch descriptions. For each, use sliders to design a haptic profile that matches the described sensation.',
      consent_part2: '<strong>Brief demographics and feedback (~2 min).</strong>',
      consent_part3: '',
      ...
      part1_param_freq: '<strong>Vibration Speed:</strong> how fast the vibration pulses (1Hz = slow throb, 500Hz = high buzz)',
      part1_param_thermal: '<strong>Temperature:</strong> cold (−30°C) to hot (+30°C), 0 = neutral',
    ...
    zh: {
      ...
      consent_part1: '<strong>触觉设计（约8分钟）：</strong>阅读10段幽灵触感描述，每段使用滑块设计一个与描述匹配的触觉配置。',
      consent_part2: '<strong>简短的基本信息和反馈（约2分钟）。</strong>',
      consent_part3: '',
      ...
      part1_param_freq: '<strong>振动速度：</strong>振动脉冲的快慢（1Hz = 缓慢搏动，500Hz = 高频嗡鸣）',
      part1_param_thermal: '<strong>温度：</strong>冷（-30°C）到热（+30°C），0 = 中性',
