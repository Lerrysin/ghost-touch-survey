...
const I18N = (() => {
  ...
  const translations = {
    en: {
      ...
      part1_param_intro: 'The 6 parameters you can adjust:',
      ...
      part1_param_onset: '<strong>Start Speed:</strong> how quickly the sensation begins (50ms = instant, 2000ms = gradual)',
      part1_param_dur: '<strong>Duration:</strong> how long the sensation lasts (200ms = flash, 6000ms = lingering)',
      part1_task: '<strong>Tip:</strong> There are no right or wrong answers. Trust your intuition — what would this description "feel like" as a physical touch?',
    ...
    zh: {
      ...
      part1_param_onset: '<strong>起始速度：</strong>触感开始的快慢（50ms = 瞬间，2000ms = 渐进）',
      part1_param_dur: '<strong>持续时间：</strong>触感持续多久（200ms = 一闪，6000ms = 持久）',
      part1_task: '<strong>提示：</strong>没有对错之分。请相信您的直觉——这段描述如果变成真实的触觉，应该"摸起来"是什么感觉？',
